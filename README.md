...
3. Pre-training step: Run the command at the root of this project dirtory
```
...
```
python  main_for_UDA.py --root_dir [datasets_root_path]  --dataset [DATASET_NAME]  --source [source_name] --target [target_name] --phase train --gpu [the_gpu_code]  --steps [max_steps] --lambda_div  [0 < lambda_div < 1]
```
For example, 
 ```
