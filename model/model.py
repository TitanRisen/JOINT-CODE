...
from loss.loss import JSdiv_loss
...
class JOINT(nn.Module):
    ...
    def forward(self, source, target=None, source_label=None, target_label=None, test_upper_bound=False):
        ...
        if self.training == True and target is not None:
            ...
            loss = JSdiv_loss(source_features, source_label, target_features, target_l, DEVICE, lamda=self.lambda_div, alpha=self.alpha, beta=self.beta )
