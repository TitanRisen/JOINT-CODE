...
def train_for_UDA(args, model, optimizer, dataloaders):
    ...
    for step in range(1, args.steps + 1):
        ...
        if step > 0 and step % args.log_interval == 0:
            ...
            print('Step: [{}/{}]: lambd:{}, div_loss:{:.4f}, cls_loss:{:.4f}, total_loss:{:.4f}'.format(step, args.steps, lambd, div_loss, cls_loss, loss))
        if step > 0 and step % args.save_interval == 0:
            ...
            if step >= args.start_update_step and step % args.update_interval == 0 :
                pseudo_labels = predict(model, dataloaders['tar_test'],step=step)
            ...
            if args.early:
                if acc_tar > best_acc:
                    ...
                    if args.save_check : 
                        ...
                        torch.save(model.state_dict(), '{}/best_JOINT_{}_{}_to_{}.pth'.format(check_path, args.net, args.source, args.target))
                else:
                    counter += 1
